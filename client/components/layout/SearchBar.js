        ...
        <div className="w-full">
          ...
          <div className="relative">
            ...
            <input
              ...
              name="search"
              id="search"
              className="pl-9 block w-full rounded-md border-0 py-1.5 text-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 sm:text-sm sm:leading-6"
